...
st.markdown("<h1 style='text-align: left; text-decoration: underline'>Extract Tweets</h1>", unsafe_allow_html=True)
st.write("")
st.write("")
...
if 'data' in st.session_state.keys():
    st.markdown("<h1 style='text-align: left; text-decoration: underline;'>Dataset</h1>", unsafe_allow_html=True)
    st.write("")
    st.write("")
